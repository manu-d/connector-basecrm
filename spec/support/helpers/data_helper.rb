    ...
    [
      {
        "data" =>
        {
          ...
          "contact_id" => nil,
          "created_at" => "2016-07-19T10:20:07Z",
          "updated_at" => "2016-07-22T08:42:20Z",
          "title" => nil,
          "name" => "Base CRM",
          "first_name" => nil,
          "last_name" => nil,
      ...
      "meta" => {"version" => 2,"type" => "contact"}},
      {
        "data" =>
        {
          ...
          "contact_id" => nil,
          "created_at" => "2016-07-19T10:20:07Z",
          "updated_at" => "2016-07-22T08:42:10Z",
          "title" => nil,
          "name" => "Base CRM 2",
          "first_name" => nil,
          "last_name" => nil,
      ...
      "meta" => {"version" => 2,"type" => "contact"}},
      {
        "data" =>
        {
          ...
          "contact_id" => nil,
          "created_at" => "2016-07-19T10:20:07Z",
          "updated_at" => "2016-07-22T08:42:06Z",
          "title" => nil,
          "name" => "Base CRM 3",
          "first_name" => nil,
          "last_name" => nil,
      ...
      "meta" => {"version" => 2,"type" => "contact"}},
      {
        "data" =>
        {
          ...
          "contact_id" => 135906739,
          "created_at" => "2016-07-19T10:20:07Z",
          "updated_at" => "2016-07-22T08:42:25Z",
          "title" => nil,"name" => "Support Team",
          "first_name" => "Support",
          "last_name" => "Team",
          "description" => nil,
      ...
      "meta" =>
      {
      "type" => "collection","count" => 4,
      "links" =>
        {
          "next_page" => "https://api.getbase.com/v2/contacts?page=2&per_page=4"
        }
      }
    }.to_json
end
